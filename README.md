...
# Degiro Interactive Visual Tool
...
2. Your data is not logged in any way, shape or form. It's only cached on [Streamlit](https://streamlit.io/) servers for faster access everytime you use it. No one has access to it (code is open source so fell free to confirm it).
